export class CanvasEngine {
    /**
     * @param {HTMLCanvasElement} canvas The element to draw on. Previously this
     *   took a global DOM id, which coupled the engine to markup it did not own
     *   and collided with any host element using the same id.
     */
    constructor(canvas) {
        this.canvas = canvas;
